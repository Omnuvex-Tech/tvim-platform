...
type TranslationDictionary = {
    ...
    account: {
        ...
        /**
         * Order and payment status codes arrive from the api with labels that are
         * not localized, so the code is mapped here and the api text is only used
         * as a fallback for codes this map does not know.
         */
    ...
    az: {
        ...
        account: {
            ...
            paymentStatuses: {
                pending: "Gözləyir",
                awaiting: "Gözləyir",
                authorized: "Bloklandı",
                paid: "Ödənildi",
                partially_paid: "Qismən ödənildi",
                unpaid: "Ödənilməyib",
                failed: "Uğursuz oldu",
                canceled: "Ləğv edildi",
                cancelled: "Ləğv edildi",
                refunded: "Məbləğ qaytarıldı",
                partially_refunded: "Qismən qaytarıldı",
                expired: "Vaxtı bitdi",
